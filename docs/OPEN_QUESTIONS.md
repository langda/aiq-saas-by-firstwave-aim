...
GDPR-style delete/export? Target markets (EU? SEA?)? Decision 9 established privacy-by-default for orgs — this question is the _platform-level_ posture: retention, deletion rights, DPA readiness. Not a code blocker; a launch blocker.
